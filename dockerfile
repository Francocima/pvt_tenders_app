...
# Install ChromeDriver -- changed chromedriver version
RUN wget https://storage.googleapis.com/chrome-for-testing-public/131.0.6778.87/linux64/chromedriver-linux64.zip -P /tmp \
